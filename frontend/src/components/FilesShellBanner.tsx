      ...
      <div className="card-body p-3 p-md-4">
        <div className="d-flex flex-column flex-lg-row justify-content-between gap-3 align-items-lg-center">
          <div>
            ...
            <h1 className="h3 mb-2">The files UI now runs entirely through the shared React browser</h1>
            <p className="text-secondary mb-0">
              Both the full page and the embedded browser use the same typed API layer,
              React-owned document shell, and shared browser component tree.
            </p>
          </div>
